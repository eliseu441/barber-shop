...
const Barber = () => {
  const [topServices] = useState([
    ...
    { id: 3, carouselName: 'carouselCorte.jpg', name: 'Corte', description: 'Pacote completo de corte e barba', price: 'R$ 70' },
    { id: 4, carouselName: 'carouselCorteBarba.avif', name: 'Corte + Barba', description: 'Pacote completo de corte e barba', price: 'R$ 70' },
    { id: 5, carouselName: 'carouselDescoloracao.jpg', name: 'Descoloração', description: 'Pacote completo de corte e barba', price: 'R$ 70' },
  ]);
